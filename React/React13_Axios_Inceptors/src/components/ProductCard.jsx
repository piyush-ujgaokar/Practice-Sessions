const ProductCard = ({ product }) => {
  return (
    <div className="group w-full max-w-sm overflow-hidden rounded-2xl border border-gray-800 bg-black shadow-xl transition duration-300 hover:-translate-y-1 hover:border-gray-700">
